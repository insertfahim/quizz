...
import { Plus, Edit, Eye, MoreVertical, Users, Clock, CheckCircle, XCircle, BookOpen } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage all your created quizzes</p>
        </div>
      ...
      {quizzes.length === 0 ? (
        <Card>
          <CardContent className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No quizzes created yet</h3>
            <p className="text-gray-600 mb-6">Start by creating your first quiz for students</p>
            <Link href="/teacher/quiz/create">
              <Button>
                <Plus className="w-4 h-4 mr-2" />
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1">{quiz.category.name}</p>
                  </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2 pt-2">
                    <Link href={`/teacher/quiz/${quiz.id}`} className="flex-1">
