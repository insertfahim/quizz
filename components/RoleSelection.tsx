                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <Card className="cursor-pointer hover:shadow-lg transition-shadow border-2 hover:border-blue-200">
                        <CardHeader className="text-center">
                            ...
                            <CardDescription>
                                Take quizzes, track your progress, and view your
                        ...
                        <CardContent>
                            <ul className="space-y-2 text-sm text-gray-600 mb-6">
                                <li>
                                    • Take quizzes across different subjects
                                </li>
                    ...
                    <Card className="cursor-pointer hover:shadow-lg transition-shadow border-2 hover:border-green-200">
                        <CardHeader className="text-center">
                            ...
                            <CardDescription>
                                Create and manage quizzes, view student
                                performance, and track class progress
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ul className="space-y-2 text-sm text-gray-600 mb-6">
                    ...
                    <Card className="cursor-pointer hover:shadow-lg transition-shadow border-2 hover:border-purple-200">
                        <CardHeader className="text-center">
                            ...
                            <CardDescription>
                                Manage users, oversee system operations, and
